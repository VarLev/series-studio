...
export const LLM_MODELS: Array<{ id: string; label: string; hint: string; hintEn: string }> = [
  ...
  { id: "claude-sonnet-4-6", label: "Sonnet 4.6", hint: "баланс", hintEn: "balanced" },
  { id: "claude-haiku-4-5", label: "Haiku 4.5", hint: "быстрый и дешёвый", hintEn: "fast and cheap" },
  { id: "gpt-5.6-sol", label: "GPT-5.6 Sol", hint: "OpenAI, топовая (по умолчанию)", hintEn: "OpenAI, frontier (default)" },
